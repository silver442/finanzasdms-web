        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
            {pendingTransfer.map(loan => {
              ...
              return (
                <div key={loan.id} className="bg-slate-800 border border-violet-500/30 rounded-2xl shadow-xl p-5 flex flex-col gap-3">
                  ...
                  {loan.disbursementAccount && (
                    <div className="bg-slate-900 rounded-lg p-3 text-sm">
                      <p className="text-slate-500 text-xs mb-0.5">CLABE de Depósito</p>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              ...
              {approveCategory.canEdit ? (
                ...
                <div className="flex items-center gap-2 bg-slate-700/40 border border-slate-600 rounded-lg px-3 py-2 text-xs text-slate-300">
              ...
              {/* Capital */}
              <div>
                <label className="block text-sm text-slate-300 font-medium mb-1">Capital ($)</label>
                <input
                  type="number"
                ...
                {approveValidation.amountError
                  ...
                  : <p className="text-xs text-slate-500 mt-1">
                      Monto original solicitado: <span className="text-emerald-400">{fmt(approveTarget.amount)}</span>
                    </p>
                }
              </div>
              ...
              {/* Tasa de interés */}
              <div>
                <label className="block text-sm text-slate-300 font-medium mb-1">Tasa de Interés a Aplicar (%)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="flex items-center gap-1.5 text-sm text-slate-300 font-medium mb-1">
                  Plazo <Lock size={12} className="text-slate-500" />
                </label>
                <input
                  type="text"
                  ...
                  readOnly
                />
                <p className="text-xs text-slate-500 mt-1">El plazo no puede modificarse.</p>
              </div>
              ...
              {(() => {
                ...
                return (
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-3 text-sm">
                    ...
                    <p className="text-white">
                      Total a pagar: <strong className="text-emerald-400">{fmt(total)}</strong>
                    </p>
                    <p className="text-white">
                      Cuota estimada: <strong className="text-emerald-400">
