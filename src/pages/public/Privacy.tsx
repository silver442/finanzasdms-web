        ...
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc list-inside space-y-2 text-text-secondary pl-2">
              <li><span className="text-text-primary font-medium">Datos de cuenta:</span> nombre completo, dirección de correo electrónico, número de teléfono y contraseña (almacenada de forma cifrada).</li>
              <li><span className="text-text-primary font-medium">Información de transacciones y préstamos:</span> montos solicitados, historial de pagos, cuotas, fechas de vencimiento y nivel de gamificación.</li>
              <li><span className="text-text-primary font-medium">Datos de uso de la plataforma:</span> módulos activados, interacciones con el dashboard y métricas de comportamiento dentro de la aplicación.</li>
              <li><span className="text-text-primary font-medium">Datos técnicos:</span> dirección IP, tipo de navegador y sistema operativo, únicamente con fines de seguridad y diagnóstico.</li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-brand-green-light">2. Uso de la información</h2>
            <p className="text-text-primary leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-brand-green-light">3. Seguridad de los datos</h2>
            <p className="text-text-primary leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-brand-green-light">4. Derechos del usuario (ARCO)</h2>
            <p className="text-text-primary leading-relaxed">
              De conformidad con la LFPDPPP, tienes derecho a:
            </p>
            <ul className="list-disc list-inside space-y-2 text-text-secondary pl-2">
              <li><span className="text-text-primary font-medium">Acceso:</span> conocer qué datos personales tenemos sobre ti y cómo los utilizamos.</li>
              <li><span className="text-text-primary font-medium">Rectificación:</span> solicitar la corrección de datos inexactos o incompletos.</li>
              <li><span className="text-text-primary font-medium">Cancelación:</span> pedir la supresión de tus datos cuando no sean necesarios para la prestación del servicio.</li>
              <li><span className="text-text-primary font-medium">Oposición:</span> oponerte al uso de tus datos para finalidades específicas.</li>
            </ul>
            <p className="text-text-primary leading-relaxed">
              Para ejercer cualquiera de estos derechos, contáctanos a través de la página de <Link to="/contact" className="text-brand-green-light hover:underline">Contacto</Link>. Atenderemos tu solicitud en los plazos establecidos por la legislación aplicable.
            </p>
          </section>
